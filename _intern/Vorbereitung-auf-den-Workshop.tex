...
\date{12. Juni 2025} % without \date command, current date is supplied
...
\sidenote{Eine Liste ist auf \url{https://git-scm.com/downloads/guis} zu finden.}
aussuchen.
...
\newthought{Ist es für den Workshop zwingend notwendig, git zu lernen?}
...
Wählen Sie die \texttt{environment.yml} aus den soeben bezogenen Dateien aus (sie liegt auf der obersten Ebene des Projektordners) und geben Sie die zu erstellenden Umgebung in der unteren Zeile einen passenden Namen, z.\,B. % 
\texttt{intro-jupyter-notebooks}.
Durch das Klicken auf den Import-Button schließen Sie den Vorgang ab.
